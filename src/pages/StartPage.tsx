...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    description: 'FAST-Prinzipien, SUM-Werte und das Drei-Zonen-Modell kennenlernen — und den Maßstab am eigenen Vorhaben erproben.',
    detail: 'Legal ist nicht gleich vertretbar. Erarbeiten Sie hier den Maßstab und prüfen Sie ihn mit dem Bewertungsassistenten an einem konkreten Fall. Festgeschrieben wird er anschließend in der Ethik-Dimension Ihrer Governance-Richtlinie — ohne diesen Schritt füllen Sie die dort ins Blaue.',
    effort: '~30 Min.',
    to: '/ethik',
    cta: 'KI-Ethik öffnen',
  },
