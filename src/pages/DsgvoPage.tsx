...
const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    details: 'Die DSFA muss VOR dem Einsatz erfolgen — eine nachträgliche DSFA erfüllt ihren Zweck nicht. Auslöser: Mitarbeiterdaten werden systematisch verarbeitet, KI-gestütztes Profiling findet statt, oder das System wird neu eingesetzt (nicht nur geringfügig angepasst).',
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          { label: 'Dreistufenmodell', value: '3', sub: 'Stufen zur Entscheidungsverantwortung' },
