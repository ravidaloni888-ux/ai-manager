    ...
    <div className="p-6 space-y-6">
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          {/* Decision Tree */}
          {/* Die Einstufung passiert am Anwendungsfall */}
          <div className="bg-slate-50 border border-slate-200 rounded-xl px-5 py-4">
            <p className="text-sm font-semibold text-slate-700">Eigene Systeme stufen Sie am Anwendungsfall ein</p>
            <p className="text-xs text-slate-500 mt-1 leading-relaxed">
              Der Risikoklassen-Check fragt nach einem konkreten System. Sie finden ihn im
              Anwendungsfall unter <strong>Prüfungen zu diesem Fall</strong>. Hier stehen die Klassen und Pflichten dahinter.
            </p>
          </div>
