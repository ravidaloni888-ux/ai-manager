...
export default function EthikPage() {
  ...
  return (
    <div className="p-6 space-y-8 max-w-4xl">
      ...
      {/* ── WIZARD ── */}
      {/* Die Fallbewertung ist an den Anwendungsfall gewandert */}
      <div className="bg-slate-50 border border-slate-200 rounded-xl px-5 py-4">
        <p className="text-sm font-semibold text-slate-700">Einzelne Vorhaben bewerten Sie am Anwendungsfall</p>
        <p className="text-xs text-slate-500 mt-1 leading-relaxed">
          Der FAST-Bewertungsassistent braucht eine konkrete Fallbeschreibung. Sie finden ihn im
          Anwendungsfall unter <strong>Prüfungen zu diesem Fall</strong>. Hier steht der Maßstab dahinter.
        </p>
      </div>
