          ...
          <div className="flex items-center gap-2">
            {existing && (
              <>
                <button
                  type="button"
                  onClick={() => navigate(`/project-plan?ucid=${existing.id}`)}
                  className="flex items-center gap-1.5 text-sm border border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100 px-3 py-2 rounded-lg shadow-sm transition-colors"
                >
